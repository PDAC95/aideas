...
export function TopAutomationCard({
  ...
  return (
    <div className="bg-primary text-primary-foreground rounded-xl p-6 min-h-[140px] flex flex-col justify-between">
      <div>
      ...
      <div className="flex items-center gap-3 mt-4 flex-wrap">
        ...
        <span className="inline-flex items-center gap-1 bg-primary-foreground/20 rounded-full px-3 py-1 text-xs font-medium">
          <span className="text-primary-foreground/70">{translations.status}:</span>
