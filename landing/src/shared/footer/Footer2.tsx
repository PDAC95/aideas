              ...
              <div className="d-flex flex-wrap align-items-start gap-5">
                <div className="at-header-logo">
                  <Link to="/" className="text-decoration-none d-inline-flex align-items-center gap-2">
                    <img data-width="30" src="/assets/imgs/template/logo/favicon-dark.svg" alt="AIDEAS" width={30} height={30} />
                    <h6 className="fw-700 text-white mb-0 fz-24">AIDEAS</h6>
                  </Link>
                </div>
                <div className="d-flex flex-column gap-3">
                  <h6 className="text-white mb-2">
                    <a href="mailto:hello@aideas.ca" className="text-white text-decoration-none">
                      hello@aideas.ca
                    </a>
                  </h6>
              ...
              <div className="at-footer-widget alt-footer-link-item-wrap row">
                ...
                <div className="alt-footer-link-item col-6">
                  <ul>
                    ...
                    <li className="mb-15">
                      <a href={`${import.meta.env.VITE_APP_URL ?? "https://app.aideas.ca"}/login`}>Log in</a>
                    </li>
                    <li className="mb-15">
                      <a href={`${import.meta.env.VITE_APP_URL ?? "https://app.aideas.ca"}/signup`}>Sign up</a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="footer-2-border pt-40 pb-40">
            <div className="row align-items-end g-4">
              <div className="col-lg-10 col-md-8">
                <span className="at-footer-copyright">AIDEAS © 2026</span>
